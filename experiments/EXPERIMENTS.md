...
| --- | --- | --- | --- | --- |
| E003 | **Produce predicted geffs for the training samples** by running the forked pipeline over `train/` | critical path | GPU | **next** |
| E004 | Confidence-ordered edge ids + explicit out-degree cap | 1 | ~0 | ready, sign known |
